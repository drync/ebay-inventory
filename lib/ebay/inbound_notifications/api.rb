...
require 'ebay/inbound_notifications/api_methods'
require 'ebay/inbound_notifications/response'
...
module Ebay #:nodoc:
  module InboundNotifications # :nodoc:
    ...
    # the correct Ebay::InboundNotifications::Requests object for the method called.
    #
    # http://developer.ebay.com/DevZone/store-pickup/Concepts/InStorePickupGuide.html#InboundNotificationsOverview
    class Api
      include Inflections
      include ApiMethods
      ...
      self.sandbox_url = 'http://eventbridge.sandbox.ebay.com/eventbridge'
      self.production_url = 'https://svcs.ebay.com/eventbridge'
      ...
      def invoke(request, path)
        ...
        request_headers = build_headers(request)
      ...
      def build_headers(request)
        {
          ...
          'X-EBAY-EVENT-TYPE' => request.type
        }
      end
